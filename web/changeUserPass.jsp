...
<div id="teaser">
  <div class="wrap">
    ...
    <div class="box">
      ...
      <p>Web page recommendations are becoming very popular, and are shown as links to related web page, 
          related image, or popular pages at web sites. When user sends request to web server, session is
          created for the user.The main aim of the recommendation system is to predict web page or pages
          from the user current session data and other user data.</p>
    </div>
  </div>
</div>
<div id="bar">
...
<div class="wrap">
  <div class="col">
    ...
    <p> <center><form name="login" method="post" action="UpdateUserPass" onsubmit="return valid();">
                                      <table>
